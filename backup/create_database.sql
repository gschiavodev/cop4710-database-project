...
(
    ...
    CONSTRAINT unique_university_email_domain UNIQUE (email_domain)
);
...
(
    ...
    PRIMARY KEY (id),
    CONSTRAINT fk_user_university_id FOREIGN KEY (university_id) REFERENCES college_events.university(id) ON DELETE CASCADE,
